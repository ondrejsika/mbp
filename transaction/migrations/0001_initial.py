...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'transaction_transaction', (
            ...
            ('amount_btc', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=8)),
            ('amount_czk', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2)),
